...
urlpatterns = [
    ...
    url(r'^password_change_done/$', password_change_done,
        {'template_name': 'cocoa/admin_base.html'},
        name='password_change_done'),
    url(r'^password_change/$', password_change,
        {'template_name': 'cocoa/password.html',
         'post_change_redirect': 'cocoa:password_change_done'},
    ...
    url(r'^update-disease/(?P<pk>\d+)/$',
        views.UpdateDisease.as_view(), name="update"),
