...
urlpatterns = [
    ...
    url(r'^password_change_done/$', password_change_done,
        {'template_name': 'cocoa/admin_base.html'}, name='password_change_done'),
    url(r'^password_change/$', password_change, {'template_name': 'cocoa/password.html',
                                                 'post_change_redirect': 'cocoa:password_change_done'}, name='password_change'),
    url(r'^login/$', auth_views.login,
        {'template_name': 'cocoa/login.html'}, name='login'),
...
# Learn Python and Django - Build an eCommerce Website Step by Step from
# Scratch
