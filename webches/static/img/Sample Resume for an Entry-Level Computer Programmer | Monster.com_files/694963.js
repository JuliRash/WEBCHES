...
tldc.cvPx['694963'] = {};
tldc.cvPx['694963'].a = 694963;
tldc.cvPx['694963'].l = [1596680,2564009,2614531,2614539,2985972,3126927,3141486,3189082,3189105,3189313,3189316,3379842,3392576,3619648,3619650,3715273,3715280,3715281,3755402];
tldc.cvPx['694963'].i = 7; 
tldc.cvPx['694963'].c = 30; 
tldc.cvPx['694963'].t = 'h';
tldc.cvPx['694963'].m = 1440;
tldc.cvPx['694963'].vi = 0;
tldc.cvPx['694963'].vc = 0;
tldc.cvPx['694963'].hf = 0;
tldc.cvPx['694963'].x = tldc.xtra;
...
var TradeLabConvTracker = function (cdata) {
  ...
  if ( typeof tldc.tl_getAnalyticsData === 'undefined' && typeof tl_getAnalyticsData === 'function' ) tldc.tl_getAnalyticsData = tl_getAnalyticsData;   
    ...
    if ( !tldc.tl_check4xconv(694963) ) {
        if ( typeof tldc.tl_addXconv === 'function' ) tldc.tl_addXconv(694963);
      }
      else xval = 0;
  }
  if ( typeof document.cookie != 'undefined' ) {
    ...
    a.style.height = 0;
    a.style.width = 0;    
    if ( document.location.protocol == 'http:' ) asrc="http://ib.adnxs.com/px?id=694963";
    else asrc="https://secure.adnxs.com/px?id=694963";
...
if ( tldc.cvPx['694963'].hf == 0 ) {  
  if ( TradeLabConvTracker(stringify(tldc.cvPx['694963'])) ) tldc.cvPx['694963'].hf = 1;
}
